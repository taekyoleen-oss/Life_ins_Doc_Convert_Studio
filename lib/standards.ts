...
export const STANDARD_DATE = "2026. 9. 22.";
...
export const STANDARD_GUIDE = [
  ...
  "수식은 Word 수식(한글에서는 한글 수식)으로 들어 있습니다. [식] 제목 줄 아래에 설명 한 줄, 그 아래에 식 한 줄씩 둡니다. 식을 고칠 때는 수식을 눌러 고치고, 새 식은 수식 편집기(Word 는 Alt+=)로 넣거나 평문으로 적어도 됩니다 — 평문은 아래첨자 _{x+t}, 위첨자 ^{t}.",
